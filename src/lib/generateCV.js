...
const i18nData = {
  en: {
    role: 'Full Stack Developer & AI-Augmented Solutions Architect',
    contactLines: [
    ...
    jobs: [
      ...
      {
        title: 'Fullstack Engineer & DevOps Lead',
        period: '2022 - 2025',
        company: 'Chiper \u2014 B2B Marketplace (Col, Mex, Bra) | Series B Startup',
        bullets: [
  ...
  es: {
    role: 'Full Stack Developer & Arquitecto de Soluciones AI-Augmented',
    contactLines: [
      'abytecorp@gmail.com  |  +57 322 312 1409  |  brayanmurcia.lat  |  Colombia',
